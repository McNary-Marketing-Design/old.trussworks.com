// Created by iWeb 3.0.3 local-build-20130317
...
{document.write('<object id="id3" type="video/quicktime" width="323" height="199" style="height: 183px; left: 22px; position: absolute; top: -47px; width: 323px; z-index: 1; "><param name="src" value="DD_Kits_files/logo-mobile.jpg"/><param name="target" value="myself"/><param name="href" value="../Media/logo-mobile-3.m4v"/><param name="controller" value="false"/><param name="scale" value="tofit"/></object>');}
else
...
{return false;}
function onPageLoad()
{loadMozillaCSS('DD_Kits_files/DD_KitsMoz.css')
