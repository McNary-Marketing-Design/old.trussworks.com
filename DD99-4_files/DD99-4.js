...
{document.write('<object id="id3" type="video/quicktime" width="330" height="203" style="height: 187px; left: 22px; position: absolute; top: -56px; width: 330px; z-index: 1; "><param name="src" value="DD99-4_files/logo-mobile.jpg"/><param name="target" value="myself"/><param name="href" value="../Media/logo-mobile-3.m4v"/><param name="controller" value="false"/><param name="scale" value="tofit"/></object>');}
else
...
{return false;}
function onPageLoad()
{loadMozillaCSS('DD99-4_files/DD99-4Moz.css')
