...
{document.write('<object id="id3" type="video/quicktime" width="348" height="213" style="height: 197px; left: 13px; position: absolute; top: -56px; width: 348px; z-index: 1; "><param name="src" value="EZ12_Photos_files/logo-mobile.jpg"/><param name="target" value="myself"/><param name="href" value="../Media/logo-mobile-3.m4v"/><param name="controller" value="false"/><param name="scale" value="tofit"/></object>');}
else
...
{return IWCreatePhotocast("http://www.trussworks.com/trussworks/EZ12_Photos_files/rss.xml",true);}
...
IWLayoutPhotoGrid('id4',new IWPhotoGridLayout(5,new IWSize(174,174),new IWSize(174,0),new IWSize(209,189),27,27,0,new IWSize(0,0)),new IWStrokeParts([{rect:new IWRect(-1,1,2,172),url:'EZ12_Photos_files/stroke.png'},{rect:new IWRect(-4,-5,5,6),url:'EZ12_Photos_files/stroke_1.png'},{rect:new IWRect(1,-1,172,2),url:'EZ12_Photos_files/stroke_2.png'},{rect:new IWRect(173,-5,3,6),url:'EZ12_Photos_files/stroke_3.png'},{rect:new IWRect(173,1,2,172),url:'EZ12_Photos_files/stroke_4.png'},{rect:new IWRect(173,173,6,4),url:'EZ12_Photos_files/stroke_5.png'},{rect:new IWRect(1,173,172,2),url:'EZ12_Photos_files/stroke_6.png'},{rect:new IWRect(-4,173,5,4),url:'EZ12_Photos_files/stroke_7.png'}],new IWSize(174,174),true,1),imageStream,range,null,null,1.000000,{backgroundColor:'rgb(0, 0, 0)',reflectionHeight:100,reflectionOffset:2,captionHeight:100,fullScreen:0,transitionIndex:2},'Media/slideshow.html','widget1','widget2','widget3')});}
...
loadMozillaCSS('EZ12_Photos_files/EZ12_PhotosMoz.css')
